...
| ---------------------------------------------------------------------- | --------------------------------------------------------------- | ---------------- |
| [Diseño funcional](01-diseno-funcional.md)                             | ¿Qué problema resuelve y qué puede hacer el usuario?            | Aceptado v1.7    |
| [Diseño técnico](02-diseno-tecnico.md)                                 | ¿Cómo se organiza el sistema y sus datos?                       | Aceptado v1.6    |
